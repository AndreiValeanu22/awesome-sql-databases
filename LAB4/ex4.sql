SELECT id_dep,
       ...
       salariu
FROM angajati
WHERE data_ang >= TO_DATE('01-01-1981','DD-MM-YYYY')
  AND data_ang <  TO_DATE('01-01-1982','DD-MM-YYYY')
  AND id_dep IN (&dep1, &dep2);

/*
Alternativ, dacă vrei „între” inclusiv:
WHERE data_ang BETWEEN TO_DATE('01-01-1981','DD-MM-YYYY')
